...
type LoginRequest struct {
	...
	AlwaysUseFirewall             *bool   `protobuf:"varint,40,opt,name=alwaysUseFirewall,proto3,oneof" json:"alwaysUseFirewall,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *LoginRequest) GetAlwaysUseFirewall() bool {
	if x != nil && x.AlwaysUseFirewall != nil {
		return *x.AlwaysUseFirewall
	}
	return false
}
...
type GetConfigResponse struct {
	...
	AlwaysUseFirewall             bool   `protobuf:"varint,27,opt,name=alwaysUseFirewall,proto3" json:"alwaysUseFirewall,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *GetConfigResponse) GetAlwaysUseFirewall() bool {
	if x != nil {
		return x.AlwaysUseFirewall
	}
	return false
...
type SetConfigRequest struct {
	...
	AlwaysUseFirewall             *bool                `protobuf:"varint,35,opt,name=alwaysUseFirewall,proto3,oneof" json:"alwaysUseFirewall,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *SetConfigRequest) GetAlwaysUseFirewall() bool {
	if x != nil && x.AlwaysUseFirewall != nil {
		return *x.AlwaysUseFirewall
	}
	return false
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x13OSLifecycleResponse\"\xff\x12\n" +
	...
	"\x0esshJWTCacheTTL\x18' \x01(\x05H\x1aR\x0esshJWTCacheTTL\x88\x01\x01\x121\n" +
	"\x11alwaysUseFirewall\x18( \x01(\bH\x1bR\x11alwaysUseFirewall\x88\x01\x01B\x13\n" +
	...
	"\x0f_sshJWTCacheTTLB\x14\n" +
	"\x12_alwaysUseFirewall\"\xb5\x01\n" +
	"\rLoginResponse\x12$\n" +
	...
	"\x11alwaysUseFirewall\x18\x1b \x01(\bR\x11alwaysUseFirewall\"\xfe\x05\n" +
	"\tPeerState\x12\x0e\n" +
	...
	"\f_profileNameB\v\n" +
	"\t_username\"\x17\n" +
	"\x15SwitchProfileResponse\"\xa8\x11\n" +
	...
	"\x0esshJWTCacheTTL\x18\" \x01(\x05H\x17R\x0esshJWTCacheTTL\x88\x01\x01\x121\n" +
	"\x11alwaysUseFirewall\x18# \x01(\bH\x18R\x11alwaysUseFirewall\x88\x01\x01B\x13\n" +
	"\x11_rosenpassEnabledB\x10\n" +
	"\x0e_interfaceNameB\x10\n" +
	"\x0e_wireguardPortB\x17\n" +
	"\x15_optionalPreSharedKeyB\x15\n" +
