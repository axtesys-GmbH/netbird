...
const file_management_proto_rawDesc = "" +
	...
	"\x0edisableSSHAuth\x18\x0f \x01(\bR\x0edisableSSHAuth\"\x94\x05\n" +
	...
	"\vcertificate\x18\x12 \x01(\tR\vcertificate\"\xb4\x01\n" +
	"\rLoginResponse\x12?\n" +
	"\rnetbirdConfig\x18\x01 \x01(\v2\x19.management.NetbirdConfigR\rnetbirdConfig\x126\n" +
	"\n" +
	"peerConfig\x18\x02 \x01(\v2\x16.management.PeerConfigR\n" +
	...
	"\x0etranslatedPort\x18\x04 \x01(\v2\x14.management.PortInfoR\x0etranslatedPort*:\n" +
	"\tJobStatus\x12\x12\n" +
	...
	"\x03Job\x12\x1c.management.EncryptedMessage\x1a\x1c.management.EncryptedMessage\"\x00(\x010\x01B\bZ\x06/protob\x06proto3"
